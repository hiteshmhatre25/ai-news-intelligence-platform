    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 p-5 flex flex-col">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleBookmark} disabled={saving} title={bookmarked ? 'Remove bookmark' : 'Save bookmark'} className="text-lg leading-none disabled:opacity-50">
            {bookmarked ? '★' : '☆'}
          </button>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        <a href={article.link} target="_blank" rel="noopener noreferrer" className="flex-1 text-center text-sm border border-gray-200 dark:border-gray-600 rounded py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
          Read Article
        </a>
        <button onClick={() => onShowSummary(article)} className="flex-1 text-center text-sm border border-purple-200 dark:border-purple-800 rounded py-2 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/30">
          AI Summary
        </button>
      </div>
    </div>
